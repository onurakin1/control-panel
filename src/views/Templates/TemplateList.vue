    ...
    <div id="app" class="container">
      ...
      >
        <swiper-slide v-for="template in templates" :key="template.id">
          ...
          >
            <Template1
              :disabled="true"
              :mainBgColor="selectedBgColorDefault"
              :secondaryBgColor="secondaryBgColorDefault"
              :textColor="textColorDefault"
              :logoSize="'40px'"
              :iconSize="IconSizeDefault"
              :layout="layoutDefault"
              :logoUrl="logoUrlDefault"
              :mediaUrl="mediaUrlDefault"
      ...
      <div v-if="selectedTemplate" class="mt-5 template-list">
        ...
        <div class="d-flex justify-content-end mt-2">
          <!-- HTML !-->
          <router-link to="/home" class="ai-btn" role="button"
            ><span class="text">Continue <i class="bi bi-forward-fill"></i></span
          ></router-link>
        </div>
      </div>
      <div v-else>
