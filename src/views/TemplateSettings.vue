    ...
    <div id="app">
      <div class="template row">
          ...
          <div class="template-setting-form">
            <div class="mb-5">
              ...
              <div class="file-template-upload">
                ...
                <label
                  for="file-template-upload"
                  class="custom-file-template-upload"
                >
            ...
            <div class="layout-items">
              ...
              <span class="d-flex justify-content-between">
                <button
                  @click="setLayout('two')"
                  :class="{ active: layoutInternal === 'two' }"
                >
                  <i class="bi bi-grid-1x2"></i> Two Column
                </button>
                <button
                  @click="setLayout('three')"
                  :class="{ active: layoutInternal === 'three' }"
                >
            ...
            <div class="layout-items">
              ...
              <select
                v-model="selectedLanguagesInternal"
                class="form-select"
                multiple
                style="width: 200px"
        ...
        <div class="col">
          ...
          <div
            class="offcanvas offcanvas-end preview-offcanvas"
            tabindex="-1"
            id="offcanvasRight"
          ...
          >
            ...
            <div class="offcanvas-body">
              <div class="template-border">
                <component
                  :is="template"
                  :mainBgColor="selectedBgColorInternal"
                  :secondaryBgColor="secondaryBgColorInternal"
                  :textColor="textColorInternal"
                  :logoSize="'120px'"
                  :iconSize="iconSizeInternal"
                  :layout="layoutInternal"
                  :logoUrl="logoUrlInternal"
                  :mediaUrl="mediaUrlInternal"
                  :fontSize="fontSize"
                />
              </div>
            </div>
